...
//        let headerImageModel = OwnHeaderImageModel()
...
//        func steamItemDownloaded(items: [UserModel]) {
//            if items.first != nil {
//                headerImageModel.downloadItemsFromSteamQueryModel(steamQueryModel: steamQueryModel)
//            }
//        }
